...
// Algo: First reverse both the linked lists and make dummy node and simple add both the number as we do in school. The main concept is
//  sum= (a+b+carry)%10 and carry is (a+b+carry)/10; remember that and traverse the linked list.
